        ...
        <div className="mx-10 mt-12  lg:mt-16 mb-5">
          <div className="grid grid-cols-2  ">
            <div className="mx-2">
              ...
              <p className="">
                The objective of Lakshmi Agency is to establish a marketplace
                for selling interior construction and decoration products for
                both living and working spaces. The aim is to provide customers
                with a one-stop-shop where they can find all the necessary
                materials and benefit from exclusive offers . This will
                ultimately save them time, money, and energy in their search for
