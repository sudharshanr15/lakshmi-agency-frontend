  ...
  return (
    <div className="lg:hidden">
                    ...
                    <form className="w-auto hidden md:block">
                      ...
                      <div className="relative md:hidden">
                        ...
                        <input
                          type="search"
                          id="default-search"
                          className="md:hidden w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      ...
      <div className=" bg-[#2d3537] text-white p-2 flex">
        ...
        <h1 className="mx-2">
          Delivering to Trichy - <span>622023</span>
        </h1>
        <a href="#" className="mr-2 text-yellow-300 underline">
          change
        </a>
      </div>
    </div>
