...
const Total = ({ cart }) => {
  return (
    <div className="w-full fixed bottom-0 lg:relative bg-gray-100 py-5">
      <div className="mx-5 lg:mx-14 text-sm flex justify-between items-end">
        ...
        <Link href={"/dashboard/product"}>
          <div className="rounded-md w-full lg:w-fit bg-yellow-400 text-black px-14 py-2 font-bold">
