...
import { ChevronDownIcon,FunnelIcon,ChevronUpIcon } from '@heroicons/react/20/solid'
    ...
    <div className="bg-white">
      <div className='lg:flex'>
        ...
        <div className='lg:hidden'>
          ...
          <span className='text-gray-500 font-bold'>Sort by: </span><p className='px-5 py-1 text-gray-500 bg-gray-100 rounded-3xl'>Price Height to Low</p>
          </div>
          <div className='flex items-center mx-5 bg-gray-100'>
            ...
            <div className='w-full flex justify-center gap-2 text-sm items-center p-5 font-bold text-blue-900'>
              ...
              <p>10% Off <span className='font-'>On First Purchase</span></p> 
            </div>
          </div>
          ...
          <div className='fixed top-10 overflow-scroll bg-white w-screen h-screen'>
              <div className='fixed w-full z-[100] top-0 bg-[#004b71] text-yellow-300 p-5 flex'>
                <div className='cursor-pointer' onClick={()=>setMobileFiltersOpen(false)}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12h-15m0 0l6.75 6.75M4.5 12l6.75-6.75" />
              </svg></div>
              <span className='text-white ml-2'>Filters</span></div>
        ...
        <main className="hidden lg:block w-1/4 px-4 sm:px-6 lg:px-8">
          <div className="flex items-center border-b border-gray-200 py-5">
            ...
            <h1 className="text-md font-bold tracking-tight text-gray-900">Filters :</h1>
          </div>
