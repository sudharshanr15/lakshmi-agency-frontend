...
const Content = () => {
  ...
  const content=products.map((val,pos)=><Card name={val.name} mrp={val.mrp} price={val.price} 
                                              gst={val.gst} deliveryfee={val.deliveryFee} 
                                              deliverydate={val.deliveryDate} key={pos}/>)
